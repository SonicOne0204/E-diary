...
class Teacher(User):
    ...
    school: Mapped["School"] = relationship(
        "School", back_populates="teachers", passive_deletes=True
    )
    subjects: Mapped[list["Subject"]] = relationship(
        "Subject", back_populates="teachers", secondary=subject_teacher
    )
    homeworks: Mapped[list["Homework"]] = relationship(
        "Homework", back_populates="teacher"
    )
    schedules: Mapped[list["Schedule"]] = relationship(
        "Schedule", back_populates="teacher"
    )
    attendance: Mapped["Attendance"] = relationship(
        "Attendance", back_populates="teacher"
    )
...
class Principal(User):
    ...
    school: Mapped["School"] = relationship(
        "School", back_populates="principals", passive_deletes=True
    )
...
class Student(User):
    ...
    school: Mapped["School"] = relationship(
        "School", back_populates="students", passive_deletes=True
    )
    group: Mapped["Group"] = relationship(
        "Group", back_populates="students", passive_deletes=True
    )
    attendance: Mapped["Attendance"] = relationship(
