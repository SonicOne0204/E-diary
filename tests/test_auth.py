...
from app.db.models.types import Student, Principal
...
async def test_login_success(client: AsyncClient, db_session):
    ...
    response = await client.post("/auth/login/", data=payload, headers={"Content-Type": "application/x-www-form-urlencoded"})
