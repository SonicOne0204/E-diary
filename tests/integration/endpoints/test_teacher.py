...
from tests.integration.endpoints.fixtures.teacher import override_get_current_user_teacher_wrong_school
from tests.integration.conftest import override_get_current_user_teacher, override_get_current_user_admin
from app.services.auth import get_current_user
from app.main import app

def test_assign_grade(test_get_db, test_client, create_schedule, create_student_fixture):
    try:
        ...
        response = test_client.post('/teacher/assign-grade', json={
...
def test_assign_grade_wrong_school(test_get_db, test_client, create_schedule, create_student_fixture):
    try:
        app.dependency_overrides[get_current_user] = override_get_current_user_teacher_wrong_school
